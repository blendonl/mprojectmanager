...
export class CachedAgendaService {
  ...
  async getAllSchedulableTasks(projectId?: ProjectId, goalId?: string): Promise<ScheduledTask[]> {
    throw new Error('getAllSchedulableTasks: This method needs to be refactored to use backend endpoints.');
  }
  ...
  async scheduleTask(
    ...
    throw new Error('scheduleTask: This method needs to be refactored to use backend endpoints. Use createAgendaItem instead.');
  }
  ...
  async setTaskType(boardId: BoardId, taskId: TaskId, taskType: TaskType): Promise<void> {
    throw new Error('setTaskType: This method needs to be refactored to use backend endpoints.');
  }

  async updateMeetingData(boardId: BoardId, taskId: TaskId, meetingData: MeetingData): Promise<void> {
    throw new Error('updateMeetingData: This method needs to be refactored to use backend endpoints.');
  }

  async unscheduleTask(boardId: BoardId, taskId: TaskId): Promise<void> {
    throw new Error('unscheduleTask: This method needs to be refactored to use backend endpoints.');
  }
